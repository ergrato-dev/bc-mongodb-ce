...
```
week-10-aggregation_pipeline_ii_acumuladores_avanzados/
├── README.md
...
| | Enlace |
|---|---|
| ← Semana anterior | [Semana 09 — Aggregation Pipeline I](../week-09-aggregation_pipeline_i/README.md) |
| → Semana siguiente | [Semana 11 — $lookup y $unwind](../week-11-lookup_y_unwind_joins/README.md) |
