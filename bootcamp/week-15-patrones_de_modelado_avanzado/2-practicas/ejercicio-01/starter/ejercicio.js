...
// Sin el patrón, necesitamos un $lookup para obtener el nombre del autor.
// Observa la complejidad vs. el paso siguiente.
...
// Con el patrón, los campos del autor ya están embebidos en cada post.
// No necesitamos $lookup — lectura directa y eficiente.
// Descomenta las siguientes líneas:
...
// El autor "auth-01" cambia su nombre a "Ana Torres Gómez".
// Debemos actualizar: (a) la colección authors (fuente de verdad)
//                     (b) todos los posts que tienen su authorInfo embebido.
// Descomenta las siguientes líneas:
...
// Cada vez que llega un comentario nuevo, lo agregamos a topComments
// pero mantenemos solo los 3 más recientes con $push + $slice: -3.
// También incrementamos commentCount.
// Descomenta las siguientes líneas:
