...
```
week-12-aggregation_pipeline_iii_facet_bucket_replaceroot_merge/
├── README.md
...
- [← Semana 11](../week-11-lookup_y_unwind_joins/README.md) — $lookup y $unwind
- [→ Semana 13](../week-13-indices_avanzados_compuestos_ttl_parciales_y_unicos/README.md) — Índices Avanzados
