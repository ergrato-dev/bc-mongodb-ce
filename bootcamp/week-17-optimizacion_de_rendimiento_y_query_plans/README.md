...
```
week-17-optimizacion_de_rendimiento_y_query_plans/
├── 0-assets/
...
← [Semana 16 — Validación y Transacciones](../week-16-validacion_de_esquemas_y_transacciones_acid/README.md)
→ [Semana 18 — Patrones de Esquema Adicionales](../week-18-patrones_de_esquema_avanzados_ii/README.md)
